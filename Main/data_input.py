...
class DataInput:
    ...
    def inputFunction(self):
        try:
            ...
            if file_extension == "":
                raise SystemExit(
                    f"Provide the " + "DATASET" + " name (with extension).\U0001F643"
                )

            if file_extension not in self.supported_file_extensions:
                raise SystemExit(
                    f"This file extension is not " + "supported.\U0001F643"
                )
        ...
        try:
            ...
            raise SystemExit(f"The file is " + "EMPTY" + "\U0001F635")

        except FileNotFoundError:
            raise SystemExit(f"File " + "doesn't" + " exist\U0001F635")
